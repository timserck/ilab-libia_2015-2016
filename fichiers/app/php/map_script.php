...
function initAutocomplete() {
  ...
  var map = new google.maps.Map(document.getElementById('map_mobile'),
    mapOptions);
  ...
  initialLocation = new google.maps.LatLng(position.coords.latitude,position.coords.longitude);
    ...
    var marker = new google.maps.Marker({
      ...
      icon:'https://chart.googleapis.com/chart?chst=d_map_pin_letter&chld='+ 'ici' +'|20D699' 
    });   
...
current_position();
 ...
 function trajet(marker_position){
  ...
  $.getJSON("pages/namur.json", function(json1) {
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDantvsbWyrcyA1y91q_YaYbxEdYyQ876U&amp;callback=initAutocomplete&amp;libraries=places" type="text/javascript"></script>